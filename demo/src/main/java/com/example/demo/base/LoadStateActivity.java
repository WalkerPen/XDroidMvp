 ...
 * 加载状态切换、有默认toolbar、可自定义toolbar、可固定头部
 */

public abstract class LoadStateActivity<P extends LoadStatePersenter> extends RxAppCompatActivity implements LoadStateView<P> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getLayoutId() > 0) {
            ...
            mStateController.setContentView(mContentView);
            showContent();
            bindUI(mContentView);
            bindEvent();
        }
